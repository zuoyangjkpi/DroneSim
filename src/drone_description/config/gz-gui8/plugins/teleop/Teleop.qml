...
import gz.gui 1.0
 ...
 ColumnLayout {
  ...
  function sendCommand(_forwardScale, _yawScale) {
    var forwardVel = _forwardScale * maxForwardVel;
    var yawVel = _yawScale * maxYawVel;
    Teleop.OnTeleopTwist(forwardVel, 0.0, yawVel)
  }
  ...
  Label {
    ...
    Layout.margins: 10
    ToolTip.text: "Value that's set by buttons and keys."
      ...
      GridLayout {
        ...
        Button {
          ...
          onClicked: {
            ...
            sendCommand(forwardScale(), yawScale());
          }
